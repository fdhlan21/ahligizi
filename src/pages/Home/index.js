...
<TouchableNativeFeedback onPress={() => navigation.navigate('MakananBalita')}>
  <View style={{padding:10, backgroundColor:colors.primary, height:100, width:100, borderRadius:50,
  flexDirection:"row",
  justifyContent:"center",
  alignItems:'center',
  ...
  <View style={{}}>
          <Image source={require('../../assets/makananbalita.png')} style={{height:50, width:50, alignItems:"center",
...
<TouchableNativeFeedback onPress={() => navigation.navigate('Makananibuhamil')}>
  ...
  <View style={{}}>
          <Image source={require('../../assets/makananibuhamil.png')} style={{height:50, width:50, alignItems:"center",
          alignSelf:"center", marginTop:"60%"}}/>
  ...
  <View style={{}}>
          <Image source={require('../../assets/konsultasionline.png')} style={{height:50, width:50, alignItems:"center",
          alignSelf:"center", marginTop:"60%"}}/>
...
<TouchableNativeFeedback onPress={() => navigation.navigate('ProfileAplikasi')}>
  ...
  <View style={{}}>
          <Image source={require('../../assets/profilepembuataplikasi.png')} style={{height:50, width:50, alignItems:"center",
